...
Para saber más sobre este filtro: \ref {suavizado_label} (página \pageref{suavizado_label}).
...
Para saber mas sobre la extracción:  \ref {regiones_label} (página \pageref{regiones_label}).
...
Para saber mas sobre el centrado: \ref {centrado_label} (página \pageref{centrado_label}).
