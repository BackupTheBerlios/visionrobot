...
La imagen de la derecha muestra cual sería la coordenada que representa el centro de masas del conjunto de píxeles negros.
\end{center} 
...
\hline 
\end{tabular} 
La imagen de la izquierda muestra la dirección en que se deben desplazar todos los píxeles.
