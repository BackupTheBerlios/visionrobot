...
\bigskip 
Para saber más: introducción sobre redes neuronales, en capítulo \ref {Introduccion_redes} (página \pageref{Introduccion_redes}).

\subsection{Descripción técnica}
La red neuronal utilizada es una red multicapa de sigmoides con retropropagación.
\bigskip 
Para saber más: descripción técnica de nuestra red, en capítulo \ref {Descripcion_tecnica} (página \pageref{Descripcion_tecnica}).
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5,bb=0 0 340 296]{prog_train.png}
...
\begin{figure}[h]
  ...
  \caption{ Gráfica que muestra como aumenta el aprendizaje cuanto mas se enseña a la red. Aumentando el nº de aciertos.}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4,bb=0 0 491 237]{Grafica_Errores.png}
  \caption{ Gráfica que muestra como a medida que aprende comete menos errores reconociendo figuras.}
\end{figure}

\subsection{Red Neuronal en el proyecto}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5,bb=0 0 160 120]{_orden_parada_17.png}
  \caption{ Salida: Si red de ordenes: Parar  Si red de parámetros: Nula o 0º}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5,bb=0 0 160 120]{_orden_avanza_38.png}
  \caption{ Salida: Si red de ordenes: Avanzar  Si red de parámetros: Medio baja o 45º}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5,bb=0 0 160 120]{_orden_angulo_43.png}
  \caption{ Salida: Si red de ordenes: Girar derecha  Si red de parámetros: Medio alta o 90º}
\end{figure} 

\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5,bb=0 0 160 120]{_orden_negAngulo_84.png}
  \caption{ Salida: Si red de ordenes: Girar izquierda  Si red de parámetros: Alta o 180º}
\end{figure}  

\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5,bb=0 0 160 120]{_no_gesto_36.png}
  \caption{ Salida: Si red de ordenes y parámetros: No gesto}
\end{figure}  
