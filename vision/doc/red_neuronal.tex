...
\begin{figure} [h]
  \centering
  \includegraphics[scale=0.5, bb=0 0 160 120]{prog_train.png}
  \caption{ prog\_train.png}
\end{figure}
...
Recordatorio:
\begin{itemize}
\item 1 dedo:  Avanzar     Parámetro:  Medio baja o 45º
\item 2 dedos:  Girar derecha   Parámetro:  Medio alta o 90º
\item 3 dedos:  Girar Izquierda   Parámetro:  Alta o 180º
\item  5 dedos:  Parar     Parámetro:  Nula o 0º
\end{itemize} 
 
\begin{figure} [h]
  \centering
  \includegraphics[scale=0.5,bb=0 0 160 120]{_orden_parada_17.png}
  \caption{ \_orden\_parada\_17.png}
\end{figure}
...
\begin{figure} [h]
  ...
  \caption{ \_orden\_avanza\_38.png}
\end{figure}
...
\begin{figure} [h]
  ...
  \caption{ \_orden\_angulo\_43.png}
\end{figure}
...
\begin{figure} [h]
  ...
  \caption{ \_orden\_negAngulo\_84.png}
\end{figure}
