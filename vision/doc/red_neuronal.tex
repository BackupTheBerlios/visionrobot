...
\section{Detalles} 
\begin{itemize} 
\item {\bf Entrada}: Una estructura de datos como la que definimos en \ref{formato_imagenes} con la imagen filtrada para ordenes o parametros. Procedente del módulo de filtro.
...
\section{Código}
Ver HTML: documentación del módulo en red.c y en red\_neuronal.c.
