...
\begin{figure}
  \centering
  \includegraphics[width=1.67cm,height=1.24cm,bb=0 0 63 47]{cartel.png}
  \caption{ cartel.png}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=1.67cm,height=1.24cm,bb=0 0 63 47]{cartel2.png}
  \caption{ cartel2.png}
\end{figure}
...
Para saber mas sobre la rotación, en \ref {Rotación} (página \pageref{Rotación}).
...
Para saber mas sobre estas operaciones, en \ref {Operaciones Morfológicas} (página \pageref{Operaciones Morfológicas}).
