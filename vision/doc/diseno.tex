...
\begin{itemize}
  ...
  \item Salida: Entorno 3D, control del robot y modulo de salida (muestran la salida haciendo actuar al robot real o simulado). Por fin, mostramos la salida real de todo el proceso de reconocimiento.
...
\begin{figure}[ht]
  \centering
 % \includegraphics[scale=1.0,bb=0 0 784 623]{camara_win.png}
% robot1.png: 72.009dpi, width=5.68cm, height=4.27cm, bb=0 0 161 121
