...
\paragraph{Técnicas principales:}
...
\paragraph{Retos de los sistemas OCR:}

Cuando tratamos con sistemas del tipo OCR hay que distinguir entre caracteres escritos de forma regular (mediante máquinas de escribir, imprenta, ordenador) o los escritos a mano.
