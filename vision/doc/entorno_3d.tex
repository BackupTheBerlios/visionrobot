...
A continuación se muestra un diagrama UML que de forma esquemática muestra las relaciones anteriormente descritas entre las principales clases que componen la apliación:

\begin{figure}[h]
  \centering
  \includegraphics[scale=1.0,bb=0 0 784 623]{UMLEntorno3D.png}
