...
dialogo_guardar_t *dialogo_guardar_crear()
{
  ...
  dialogo_guardar_t * dialogo_guardar = (dialogo_guardar_t *)malloc(sizeof(dialogo_guardar_t));
    ...
    dialogo_guardar->dialog_action_area2 = GTK_DIALOG(dialogo_guardar->filechooserdialog2)->action_area;
    gtk_widget_set_name(dialogo_guardar->dialog_action_area2, "dialog_action_area2");
    gtk_widget_show(dialogo_guardar->dialog_action_area2);
    gtk_button_box_set_layout(GTK_BUTTON_BOX(dialogo_guardar->dialog_action_area2),
			      GTK_BUTTONBOX_END);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(dialogo_guardar->filechooserdialog2), dialogo_guardar->button4,
				 GTK_RESPONSE_CANCEL);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(dialogo_guardar->filechooserdialog2), dialogo_guardar->button5,
				 GTK_RESPONSE_OK);
