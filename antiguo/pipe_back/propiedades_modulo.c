...
{
  propiedades_modulo_t * propiedades_modulo_o = (propiedades_modulo_t *)malloc(sizeof(propiedades_modulo_t));
    propiedades_modulo_o->propiedades_modulo = gtk_dialog_new();
    gtk_widget_set_name(propiedades_modulo_o->propiedades_modulo, "propiedades_modulo");
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->dialog_vbox4), propiedades_modulo_o->vbox4, TRUE, TRUE, 0);

    propiedades_modulo_o->label4 = gtk_label_new_with_mnemonic("_Etiqueta");
    gtk_widget_set_name(propiedades_modulo_o->label4, "label4");
    gtk_widget_show(propiedades_modulo_o->label4);
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->vbox4), propiedades_modulo_o->label4, FALSE, FALSE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->vbox4), propiedades_modulo_o->entry2, FALSE, FALSE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->vbox4), propiedades_modulo_o->hseparator1, TRUE, TRUE, 2);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->vbox4), propiedades_modulo_o->label5, FALSE, FALSE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->vbox4), propiedades_modulo_o->hbox1, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->hbox1), propiedades_modulo_o->label6, FALSE, FALSE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->hbox1), propiedades_modulo_o->entry3, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->hbox1), propiedades_modulo_o->label7, FALSE, FALSE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->hbox1), propiedades_modulo_o->entry4, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->vbox4), propiedades_modulo_o->hseparator2, TRUE, TRUE, 2);

    propiedades_modulo_o->label8 = gtk_label_new_with_mnemonic("_Ruta del m\303\263dulo");
    gtk_widget_set_name(propiedades_modulo_o->label8, "label8");
    gtk_widget_show(propiedades_modulo_o->label8);
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->vbox4), propiedades_modulo_o->label8, FALSE, FALSE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->vbox4), propiedades_modulo_o->hbox2, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->hbox2), propiedades_modulo_o->entry5, TRUE, TRUE, 0);
    ...
    gtk_box_pack_start(GTK_BOX(propiedades_modulo_o->hbox2), propiedades_modulo_o->button6, FALSE, FALSE, 0);
    g_signal_connect((gpointer) propiedades_modulo_o->button6, "clicked",
		     G_CALLBACK(on_button6_activate), propiedades_modulo_o);

    propiedades_modulo_o->dialog_action_area4 = GTK_DIALOG(propiedades_modulo_o->propiedades_modulo)->action_area;
    gtk_widget_set_name(propiedades_modulo_o->dialog_action_area4, "dialog_action_area4");
    gtk_widget_show(propiedades_modulo_o->dialog_action_area4);
    gtk_button_box_set_layout(GTK_BUTTON_BOX(propiedades_modulo_o->dialog_action_area4),
			      GTK_BUTTONBOX_END);

    propiedades_modulo_o->cancelbutton2 = gtk_button_new_from_stock("gtk-cancel");
    gtk_widget_set_name(propiedades_modulo_o->cancelbutton2, "cancelbutton2");
    gtk_widget_show(propiedades_modulo_o->cancelbutton2);
    gtk_dialog_add_action_widget(GTK_DIALOG(propiedades_modulo_o->propiedades_modulo),
				 propiedades_modulo_o->cancelbutton2, GTK_RESPONSE_CANCEL);
    GTK_WIDGET_SET_FLAGS(propiedades_modulo_o->cancelbutton2, GTK_CAN_DEFAULT);
    ...
    gtk_dialog_add_action_widget(GTK_DIALOG(propiedades_modulo_o->propiedades_modulo), propiedades_modulo_o->okbutton2,
				 GTK_RESPONSE_OK);
    GTK_WIDGET_SET_FLAGS(propiedades_modulo_o->okbutton2, GTK_CAN_DEFAULT);

    gtk_label_set_mnemonic_widget(GTK_LABEL(propiedades_modulo_o->label4), propiedades_modulo_o->entry2);
    gtk_label_set_mnemonic_widget(GTK_LABEL(propiedades_modulo_o->label6), propiedades_modulo_o->entry3);
    gtk_label_set_mnemonic_widget(GTK_LABEL(propiedades_modulo_o->label7), propiedades_modulo_o->entry4);
    gtk_label_set_mnemonic_widget(GTK_LABEL(propiedades_modulo_o->label8), propiedades_modulo_o->entry5);
