...
void Escena::Inicializar(LPDIRECT3DDEVICE9 pd3dDevice)
{
    ...
    */
    ...
    m_pAvion = new Objeto(m_pd3dDevice, std::string("modelos\\r2.x"), false);
...
void Escena::Render()
{
  ...
  /* float fFogStart = 20.0f,fFogEnd = 8000.0f;


    m_pd3dDevice->SetRenderState(D3DRS_FOGENABLE,true);
    m_pd3dDevice->SetRenderState(D3DRS_RANGEFOGENABLE,true);
    m_pd3dDevice->SetRenderState(D3DRS_FOGCOLOR,D3DCOLOR_XRGB(150,70,0));
